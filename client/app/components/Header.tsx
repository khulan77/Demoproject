    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-transparent py-6 px-10">
      <div className="max-w-7xl mx-auto flex justify-between items-center text-white">
        ...
        <nav className="hidden md:flex items-center gap-10 text-sm font-semibold tracking-wide">
          <Link href="/about" className="hover:opacity-70 transition">БИДНИЙ ТУХАЙ</Link>
          <Link href="/rules" className="hover:opacity-70 transition">ДҮРЭМ</Link>
          <Link href="/leaderboard" className="hover:opacity-70 transition">ЧАНСАА</Link>
          
          {/* НЭВТРЭХ ТОВЧ - GrapeSEED шиг дугуй загвартай */}
          <Link href="/login">
          ...
          {/* ХЭЛ СОЛИХ - Mongolia icon-той хэсэг */}
