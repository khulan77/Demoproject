...
const Hero = () => {
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      {/* 1. BACKGROUND IMAGE (Ар талын зураг) */}
      <div 
        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat transition-transform duration-1000 hover:scale-105"
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?q=80&w=2070&auto=format&fit=crop')", // Энд өөрийн зургийг тавьж болно
        }}
      >
        {/* Зургийг арай бараан болгож текст тодруулах Overlay */}
        <div className="absolute inset-0 bg-black/40" />
      </div>

      {/* 2. CONTENT (Гол текстүүд) */}
      <div className="relative z-10 text-center px-4 max-w-5xl">
        ...
        >
          ЗӨВ БИЧГИЙН <br /> <span className="text-yellow-400 font-outline-white">АВАРГА</span>
        </motion.h1>
      ...
      {/* 3. SCROLL DOWN INDICATOR (Доошоо заах сум) */}
      <motion.div 
        animate={{ y: [0, 10, 0] }}
