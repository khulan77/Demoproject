...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[85vh] bg-[#FDFBFF] flex items-center py-20 lg:py-24 overflow-hidden">
      <div className="absolute top-[-5%] right-[-10%] w-125 h-125 bg-[#F0E7FF] rounded-full blur-[120px] -z-0" />
          ...
          <div className="relative w-full max-w-[520px] aspect-[4/3] rounded-[50px] overflow-hidden border-[12px] border-white shadow-[0_40px_80px_rgba(93,49,145,0.1)] bg-white group">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-[#5D3191] font-[1000] text-[10px] uppercase tracking-tighter leading-none">
                  Шинэ сорилт
                </span>
                <span className="text-gray-400 font-bold text-[9px] uppercase mt-1">
                  Бэлэн боллоо
                </span>
              </div>
            </motion.div>
